...
class ClientOrderAccessTest(PortalTestMixin, TestCase):
    ...
    def setUp(self):
        ...
        Animal.objects.create(
            slaughter_order=self.order1,
            animal_type='cattle',
            identification_tag='PORTAL-CATTLE-001'
        )
...
class AnimalTrackingTest(PortalTestMixin, TestCase):
    ...
    def setUp(self):
        ...
        self.animal = Animal.objects.create(
            ...
            animal_type='cattle',
            identification_tag='TRACKING-001'
        )
...
class TestClientDataAccess:
    ...
    def test_client_order_query(
        self, client_profile_factory, slaughter_order_factory
    ):
