...
from reporting.services import ReportDataAggregator, ExcelReportGenerator
from users.models import User
from reception.models import SlaughterOrder, ServicePackage
from processing.models import Animal, WeightLog, CattleDetails
...
class GeneratedReportModelTest(TestCase):
    ...
    def test_generated_report_str(self):
        ...
        expected_str = f"Generated Report: {self.report.name} on {generated_report.generated_at.strftime('%Y-%m-%d %H:%M')}"
