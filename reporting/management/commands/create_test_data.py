...
from reception.models import SlaughterOrder, ServicePackage, ClientProfile
from processing.models import Animal, WeightLog, CattleDetails, SheepDetails
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f'Created data for the last 7 days (from {today - timedelta(days=6)} to {today})'))
