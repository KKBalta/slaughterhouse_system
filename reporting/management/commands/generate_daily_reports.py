    ...
    def generate_report(self, report_type, date, output_format, user):
        ...
        try:
            ...
            if output_format in ['excel', 'both']:
                ...
                excel_path = os.path.join(settings.MEDIA_ROOT, 'reports', 'daily', str(date.year), str(date.month).zfill(2))
            ...
            self.stdout.write(
                self.style.ERROR(f'Report definition not found for type: {report_type}')
            )
