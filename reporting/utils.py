...
def generate_report_data(report_definition) -> dict:
    ...
    if report_type == 'operational':
        ...
        data['results']['total_hot_carcass_weight_kg'] = carcasses_query.aggregate(Sum('hot_carcass_weight'))['hot_carcass_weight__sum'] or 0
        data['results']['avg_hot_carcass_weight_kg'] = carcasses_query.aggregate(Avg('hot_carcass_weight'))['hot_carcass_weight__avg'] or 0
