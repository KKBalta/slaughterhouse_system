...
class LabelTemplateTest(TestCase):
    ...
    def test_all_target_item_types(self):
        ...
        for i, target_type in enumerate(target_types):
            template = LabelTemplate.objects.create(
                name=f"Template {i}", template_data={}, target_item_type=target_type
            )
...
class PrintJobTest(TestCase):
    ...
    def setUp(self):
        """Set up test data."""
        self.user = User.objects.create_user(username="print_test_user", password="testpass123")
        self.template = LabelTemplate.objects.create(
            name="Print Job Template", template_data={}, target_item_type="carcass"
        )
    ...
    def test_create_print_job(self):
        ...
        job = PrintJob.objects.create(
            label_template=self.template, item_type="carcass", item_id=item_id, printed_by=self.user
        )
    ...
    def test_print_job_status_transitions(self):
        ...
        job = PrintJob.objects.create(
            label_template=self.template, item_type="carcass", item_id=uuid.uuid4(), printed_by=self.user
        )
    ...
    def test_print_job_without_user(self):
        ...
        job = PrintJob.objects.create(label_template=self.template, item_type="carcass", item_id=uuid.uuid4())
...
class PrintJobStatusTest(TestCase):
    ...
    def setUp(self):
        """Set up test data."""
        self.user = User.objects.create_user(username="status_test_user", password="testpass123")
        self.template = LabelTemplate.objects.create(
            name="Status Test Template", template_data={}, target_item_type="meat_cut"
        )
    ...
    def test_all_status_values(self):
        ...
        for status in statuses:
            job = PrintJob.objects.create(label_template=self.template, item_type="meat_cut", item_id=uuid.uuid4())
            job.status = status
            job.save()
...
class TestLabelTemplatePytest:
    ...
    def test_template_creation(self):
        ...
        template = LabelTemplate.objects.create(
            name="Pytest Template", template_data={"key": "value"}, target_item_type="carcass"
        )
    ...
    def test_template_str_representation(self):
        ...
        template = LabelTemplate.objects.create(name="Str Test Template", template_data={}, target_item_type="carcass")
...
class TestPrintJobWorkflow:
    ...
    def test_print_job_lifecycle(self, admin_user):
        ...
        template = LabelTemplate.objects.create(name="Lifecycle Template", template_data={}, target_item_type="carcass")

        # Create job
        job = PrintJob.objects.create(
            label_template=template, item_type="carcass", item_id=uuid.uuid4(), printed_by=admin_user
        )
    ...
    def test_print_job_failure_handling(self, admin_user):
        ...
        template = LabelTemplate.objects.create(name="Failure Template", template_data={}, target_item_type="carcass")
