...
urlpatterns = [
    ...
    path('labels/<uuid:label_id>/download/<str:format_type>/', views.DownloadAnimalLabelView.as_view(), name='download_animal_label'),
    path('labels/<uuid:label_id>/delete/', views.delete_animal_label, name='delete_animal_label'),
    
    # Batch Operations
    path('orders/<uuid:order_id>/batch-generate/', views.BatchGenerateLabelsView.as_view(), name='batch_generate_labels'),
