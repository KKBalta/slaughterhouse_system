...
class SlaughterOrderListViewTest(ReceptionViewTestMixin, TestCase):
    ...
    def test_order_list_filter_by_status(self):
        ...
        response = self.test_client.get(
            reverse('reception:slaughter_order_list'),
            {'status': 'IN_PROGRESS'}
        )
...
class SlaughterOrderDetailViewTest(ReceptionViewTestMixin, TestCase):
    ...
    def test_order_detail_loads(self):
        ...
        response = self.test_client.get(
            reverse('reception:slaughter_order_detail', kwargs={'pk': self.order.pk})
        )
        self.assertIn(response.status_code, [200, 302])
...
class AddAnimalToOrderViewTest(ReceptionViewTestMixin, TestCase):
    ...
    def test_add_single_animal(self):
        ...
        response = self.test_client.post(
            ...
            {
                'animal_type': 'cattle',
                'identification_tag': 'NEW-CATTLE-001'
            }
        )
    ...
    def test_cannot_add_to_non_pending_order(self):
        ...
        response = self.test_client.post(
            ...
            {
                'animal_type': 'cattle',
                'identification_tag': 'SHOULD-FAIL-001'
            }
        )
...
class OrderCancellationViewTest(ReceptionViewTestMixin, TestCase):
    ...
    def test_cancel_pending_order(self):
        ...
        response = self.test_client.post(
            reverse('reception:slaughter_order_cancel', kwargs={'pk': self.order.pk})
        )
...
class TestClientSelection:
    ...
    def test_registered_client_linked(
        self, authenticated_client, client_profile_factory, service_package_factory
    ):
    ...
    def test_walk_in_client_stored(
...
class TestOrderStatusTransitions:
    ...
    def test_order_status_updates_with_animals(
        self, slaughter_order_factory, animal_factory
    ):
    ...
    def test_order_completes_when_all_animals_done(
        self, service_package_factory
    ):
