...
class TestCompleteSlaughterWorkflow:
    ...
    def setup_workflow(self, db, user_factory, client_profile_factory, 
        ...
        self.operator = user_factory(
            username='workflow_operator',
            role=UserModel.Role.OPERATOR
        )
        self.client_user = user_factory(
    ...
    def test_complete_cattle_workflow(self, client):
        ...
        animal = Animal.objects.create(
            ...
            animal_type='cattle',
            identification_tag='WORKFLOW-CATTLE-001'
        )
        ...
        carcass = Carcass.objects.create(
            animal=animal,
            hot_carcass_weight=Decimal('300.00'),
        ...
        cut1 = DisassemblyCut.objects.create(
            animal=animal,
            cut_name='ribeye',
            weight_kg=Decimal('15.5')
        )
        cut2 = DisassemblyCut.objects.create(
            animal=animal,
            cut_name='tenderloin',
    ...
    def test_walk_in_client_workflow(self, client):
        ...
        animal = Animal.objects.create(
            slaughter_order=order,
            animal_type='goat',
            identification_tag='WALKIN-GOAT-001'
        )
...
class TestInventoryTracking:
    ...
    def setup_inventory(self, db, user_factory, service_package_factory):
        ...
        self.cooler = StorageLocation.objects.create(
            name='Main Cooler',
            location_type='cooler'
        )
    ...
    def test_inventory_creation_after_slaughter(self):
        ...
        animal = Animal.objects.create(
            slaughter_order=order,
            animal_type='cattle',
            identification_tag='INV-TRACK-001'
        )
        ...
        carcass = Carcass.objects.create(
            animal=animal,
            hot_carcass_weight=Decimal('280.00'),
    ...
    def test_inventory_movement(self):
        ...
        animal = Animal.objects.create(
            slaughter_order=order,
            animal_type='cattle',
            identification_tag='MOVE-TEST-001'
        )
        animal.perform_slaughter()
        animal.save()
    ...
    def test_daily_report_data_aggregation(self):
        ...
        for i in range(3):
            ...
            animal = Animal.objects.create(
                slaughter_order=order,
                animal_type='cattle',
                identification_tag=f'REPORT-{i:03d}'
            )
            animal.perform_slaughter()
            animal.save()
...
class TestClientPortalIntegration(TransactionTestCase):
    ...
    def setUp(self):
        ...
        self.admin = User.objects.create_user(
            username='portal_admin_integration',
            password='testpass123',
    ...
    def test_real_time_status_updates(self):
        ...
        animal = Animal.objects.create(
            slaughter_order=order,
            animal_type='cattle',
            identification_tag='REALTIME-001'
        )
