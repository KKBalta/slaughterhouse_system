...
urlpatterns = [
    ...
    path("sessions/create/animal-search/", views.SessionCreateAnimalSearchJsonView.as_view(), name="session_create_animal_search"),
    ...
    path("sessions/<uuid:session_pk>/events/<uuid:event_pk>/edit/", views.SessionEventEditView.as_view(), name="session_event_edit"),
    path("sessions/<uuid:session_pk>/events/<uuid:event_pk>/update/", views.SessionEventUpdateView.as_view(), name="session_event_update"),
    path("sessions/<uuid:session_pk>/events/<uuid:event_pk>/delete/", views.SessionEventDeleteView.as_view(), name="session_event_delete"),
