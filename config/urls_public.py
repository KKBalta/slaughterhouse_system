...
urlpatterns = [
    ...
    path(
        "platform-admin/tenants/<slug:schema_name>/impersonate-user/",
        tenant_impersonate_user,
        name="tenant_impersonate_user",
    ),
    path(
        "platform-admin/tenants/<slug:schema_name>/impersonate-lookup/",
        tenant_impersonate_identifier,
        name="tenant_impersonate_identifier",
    ),
